...
import { faq } from "../contants/index.jsx";
  ...
  return (
    <section>
      <Element name="faq" className="relative">
        ...
        <div
          className="faq-glow_before relative z-2 border-2 border-s2
          bg-s1"
        >
          ...
          <div
            className="faq-lin_after absolute left-[calc(50%-1px)] top-0 -z-1 h-full w-0.5
          bg-s2 max-lg:hidden"
          />
        </div>
      </Element>
